...
class Connection(object):
    """This class represents a connection to a src
    ...
    def __init__(
        ...
        :param auth_token: :class:`src.authentication.AuthenticationToken`
    ...
    def register_packet_listener(self, method, *packet_types, **kwds):
        ...
        If :class:`src.networking.connection.IgnorePacket` is raised from
